...
#Changes Made 8/29/20
#create new pause window for menu.
...
screen main_menu():
    ...
    if gui.show_name:    
        image Image("gui/ClassOf09logo.png") at main_logo_transform
...
screen about():
    ...
    use aboutmenu():
        vbox:
            text _("{color=#000000}This video game is entirely based on real events, encounters, and personalities. \n \nAny content viewed as offensive is a reflection of American culture and not endorsed by Class of '09 or it's staff. {/color}")
...
{size=24}LEAD PROGRAMMER{/size}
Whynne

{size=24}LEAD ARTIST{/size}
Alesha Marie

{size=24}SCENE ARTISTS{/size}
Annie Jefferis
Menii
